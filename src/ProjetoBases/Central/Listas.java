...
import ProjetoBases.Administrativo.Secretario;
import ProjetoBases.Comercial.Vendedor;
import ProjetoBases.Gestao.Diretor;
import ProjetoBases.Pedagógico.*;
...
public class Listas
{
    ...
    public static final List<Funcionario> funcionario = new ArrayList<>(); // UTILZADO NA HORA DO CADATRO / APÓS A IDA AO CONSTRUTOR ESPECÍFICO
    public static final List<Pessoa> pessoa = new ArrayList<>();           // UTILIZADO NA HORA DO CADASTRO / APÓS O ADD DE FUNCIONARIO
